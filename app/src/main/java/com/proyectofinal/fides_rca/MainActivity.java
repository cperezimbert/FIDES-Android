...
//        mFloatLabelPassword.setError(null);
        ...
        String userId = usu.getText().toString();
        ...
        if (cancel) {
            ...
            Call<UsuarioDTO> loginCall = usuarioApiService.login(new UsuarioDTO(userId, password));
            loginCall.enqueue(new Callback<UsuarioDTO>() {
                ...
                public void onResponse(Call<UsuarioDTO> call, Response<UsuarioDTO> response) {
                    ...
                    editor.putString("getNombreUsuario", usuarioDTO.getNombreUsuario());
                    editor.putString("getNombre", usuarioDTO.getNombre());
                    editor.putString("getApellido", usuarioDTO.getApellido());
                    editor.putString("getCorreo", usuarioDTO.getCorreo());
                    editor.putString("getNumeroDocumento", usuarioDTO.getNumeroDocumento());
                    editor.putString("getTipoDocumentoNombre", usuarioDTO.getTipoDocumentoNombre());
                    editor.putString("getTipoUsuarioNombre", usuarioDTO.getTipoUsuarioNombre());
                    editor.putString("getDireccion", usuarioDTO.getDireccion());
                    editor.putString("getEstadoNombre", usuarioDTO.getEstadoNombre());
