            ...
            public void onResponse(Call<UsuarioDTO> call, Response<UsuarioDTO> response) {
                try{
                    if(response.isSuccessful()){
                        ...
                        txtTipoUsuario.setText(u.getTipoUsuarioNombre());
                        txtEstado.setText(u.getEstadoNombre());
                        txtTipoDoc.setText(u.getTipoDocumentoNombre());
                        txtNroDoc.setText(u.getNumeroDocumento());
